...
/** 이 집의 것 — 바닥글의 마지막 줄에 선다. 홈은 여기에 다짐을 놓지만 여기는 시스템의 이름이다. */
export const SYSTEM_NAME = "Aurora Ledger";
...
export const CURRENT_NAV_KEY = "design";
...
export const FOOTER_BLURB = "모든 제품이 같은 목소리로 말하고 움직이게 하는 디자인 시스템입니다.";
